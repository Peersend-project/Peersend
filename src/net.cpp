...
unsigned int pnSeed[] =
{
    0xfad34229,0x49efda22,0x0403a8c0,0x0100007f
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Peersend is probably already running."), addrBind.ToString().c_str());
        else
